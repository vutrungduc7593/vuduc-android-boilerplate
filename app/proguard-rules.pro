...
# EasyAdapter rules
-keepclassmembers class * extends com.vuduc.android.easyadapter.ItemViewHolder {
    public <init>(...);
 }
...
-keepclassmembers class com.vuduc.android.boilerplate.data.model.** {
...
-keepclassmembers class com.vuduc.android.boilerplate.data.remote.RibotsService$** {
    !static !private <fields>;
}
